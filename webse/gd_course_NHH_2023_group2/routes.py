...
from webse.gd_course_NHH_2023_group2.forms import RegistrationForm, LoginForm, WalkForm, BikeForm, CarForm, BusForm, MotorcycleForm, MetroForm, TrainForm, TramForm, FerryForm, PlaneForm
...
@login_required
def new_entry():
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/new_entry.html', title='New Entry', condition = 'T')
...
@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_bike.html', methods=['GET','POST'])
@login_required
def new_entry_bike():
    form = BikeForm()
    if form.validate_on_submit():
    ...
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_bike.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_walk.html', methods=['GET','POST'])
@login_required
def new_entry_walk():
    form = WalkForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_walk.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_bus.html', methods=['GET','POST'])
@login_required
def new_entry_bus():
    form = BusForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_bus.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_car.html', methods=['GET','POST'])
@login_required
def new_entry_car():
    form = CarForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_car.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_motorcycle.html', methods=['GET','POST'])
@login_required
def new_entry_motorcycle():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_motorcycle.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_train.html', methods=['GET','POST'])
@login_required
def new_entry_train():
    form = TrainForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_train.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_ferry.html', methods=['GET','POST'])
@login_required
def new_entry_ferry():
    form = FerryForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_ferry.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_tram.html', methods=['GET','POST'])
@login_required
def new_entry_tram():
    form = TramForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_tram.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_metro.html', methods=['GET','POST'])
@login_required
def new_entry_metro():
    form = MetroForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_metro.html', title='New Entry', form=form)

@gd_course_NHH_2023_group2.route('/green_digitalization_course/NHH/2023/group2/carbon_calculator/NE/new_entry_plane.html', methods=['GET','POST'])
@login_required
def new_entry_plane():
    form = PlaneForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2023_group2.your_data'))
    return render_template('gd_course/NHH_2023_group2/carbon_calculator/NE/new_entry_plane.html', title='New Entry', form=form)
