...
from webse.sbm_course_app_calculator.forms import AddRecordForm

sbm_course_app_calculator = Blueprint('sbm_course_app_calculator', __name__)


@sbm_course_app_calculator.route('/sustainable_business_models_course/app_calculator', methods=['GET', 'POST'])
def app_calculator():
    form = AddRecordForm()
    if form.validate_on_submit():
        ...
        return render_template('sbm_course/sbm_app_calculator/app_calculator2.html', title='App Calculator', legend='App Calculator',
    ...
    return render_template('sbm_course/sbm_app_calculator/app_calculator.html', title='App Calculator', legend='App Calculator', form=form)
