...
from webse.sbm_course_NMBU_2023_group2.forms import AddRecordForm
from webse.sbm_course_NMBU_2023_group2.carbon_calculator_functions import co2_bus_calculator, co2_car_calculator, co2_plane_calculator, co2_ferry_calculator, co2_motorbike_calculator


sbm_course_NMBU_2023_group2=Blueprint('sbm_course_NMBU_2023_group2',__name__)

@sbm_course_NMBU_2023_group2.route('/sustainable_business_models_course/students_apps/NMBU_2023_group2')
def home():
  return render_template('sbm_course/sbm_NMBU_2023_group2/home.html')

@sbm_course_NMBU_2023_group2.route('/sustainable_business_models_course/students_apps/NMBU_2023_group2/methodology')
def methodology():
  return render_template('sbm_course/sbm_NMBU_2023_group2/methodology.html', title='methodology')

@sbm_course_NMBU_2023_group2.route('/sustainable_business_models_course/students_apps/NMBU_2023_group2/carbon_app', methods=['GET', 'POST'])
def carbon_app():
    form = AddRecordForm()
    if form.validate_on_submit():
        ...
        return render_template('sbm_course/sbm_NMBU_2023_group2/carbon_app/carbon_app2.html', title='App Calculator', legend='App Calculator', form=form, 
    ...
    return render_template('sbm_course/sbm_NMBU_2023_group2/carbon_app/carbon_app.html', title='App Calculator', legend='App Calculator', form=form)
